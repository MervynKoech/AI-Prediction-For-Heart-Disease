...
st.markdown("""
<style>
    /* 1. Change the global font to a modern, clean font */
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');
    html, body, stApp, [class*="css"] {
        font-family: 'Inter', sans-serif;
    }

    /* 2. Transform default Metrics into modern "Cards" */
    ...
    div[data-testid="stMetricValue"] {
        color: #0056b3 !important; /* Medical Blue */
        font-size: 32px !important;
        font-weight: 700 !important;
    }

    /* 3. Style the Primary "Predict" Button */
    ...
    /* 4. Make the Sidebar look cleaner */
...
# --- Page 4: Explainable AI (XAI) ---
    ...
    # Robustly extract positive class values and base value (handles 3D arrays safely)
    ...
    # FIX: Create an array of base_values matching the number of test samples to prevent shape errors
